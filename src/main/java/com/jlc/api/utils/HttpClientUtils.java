...
public class HttpClientUtils{
	...
	private String getRespone(HttpUriRequest req) throws Exception{
		String result = "";
		// 查看默认request头部信息
		//System.out.println("Accept-Charset:" + req.getFirstHeader("Accept-Charset"));
		...
		// 验证头部信息设置生效
		//System.out.println("Accept-Charset:" + req.getFirstHeader("Accept-Charset").getValue());
...
//            	EntityUtils.consume(entity);
	...
	public static void main(String[] args) {
		HttpClientUtils hc = new HttpClientUtils("http://192.168.18.247:8080/test/");
		try {
			hc.setParams("function", "getOnlineUser");
			hc.setParams("siteId", "500000");
			hc.setParams("siteKey", "a123456");
			System.out.println(hc.doGet());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
